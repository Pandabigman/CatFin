...
public class UserDAO {
    ...
    private int userId = SessionManager.getCurrentSession().getUserId();
    ...
    public User getUserByEmailAndPassword(String email, String password) throws SQLException {
        ...
        if (passCheck) {
            ...
            try (PreparedStatement statement = connection.prepareStatement(sql)) {
                ...
                if (rs.next()) {
                    return new User(rs.getInt("id"), rs.getString("email"), rs.getDouble("income"),
                            rs.getDouble("balance"), rs.getString("user_name"));
                }
            }
        }
        return null;
    ...
    public User getUser() throws SQLException {
        ...
        try (PreparedStatement statement = connection.prepareStatement(sql)) {
            ...
            ResultSet rs = statement.executeQuery();
            if (rs.next()) {
                return new User(rs.getInt("id"), rs.getString("email"), rs.getDouble("income"), rs.getDouble("balance"),
